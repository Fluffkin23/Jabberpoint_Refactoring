...
public class MenuController extends MenuBar {
	...
	// Adds open item to the file menu
	...
	// Adds new and save items to the file menu
	private void addNew(Menu menu)
	{
		...
		menuItem.addActionListener(e -> {
			Writer xmlWritter = new XMLWriter();
			try
			{
				xmlWritter.saveFile(presentation, SAVEFILE);
			} catch (IOException exc)
			{
				JOptionPane.showMessageDialog(parent, IOEX + exc,
	...
	// Adds exit item to the file menu
	...
	// Adds next item to the view menu
	...
	// Adds prev item to the view menu
